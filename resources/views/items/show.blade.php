...
<div id="app" class="container-fluid">
  ...
  <div class="row sticky-top" style="">
    ...
    <div class="col-3 align-self-center">
      ...
      <!-- <p>物件説明</p> -->
      <button type="button" class="btn btn-outline-danger">問い合わせする</button>
    </div>
  </div>
  <div class="row my-5 d-flex bd-highlight">
    <!-- 物件詳細情報 -->
    <div class="col-5 offset-2 flex-fill bd-highlight" >
  ...
  <div class="col-4 flex-fill bd-highlight">
    <div id="map" style=" height: 500px;" class="h-100"></div>
  </div>
</div>
<span></span>
<!-- メインコンテンツ終わり -->
