...
<div class="d-flex bd-highlight pr-0  " >
  ...
  <div class="container-fluid  flex-grow-1 bd-highlight" >
    ...
    <div class="col-lg-4 offset-8">
      <div >
        <h1 class="pt-5">College</h1>
        <h1>　Living</h1>
        <p class="pr-2">先輩の一人暮らしの体験談を見て</br>よりよい大学生活を送るための</br>お部屋探しサイト</p>
      </div>
    </div>
    ...
    <div class="p-4 bg-light" style="opacity: 0.9;">
      ...
      <button type="submit" class="btn btn-danger">体験談</button>
    </form>
  </div>
</div>
</div>
...
<div class="col-8 ">
  <div >
    <h1 class="pt-5">College</h1>
    <h1>　　Living</h1>
    <p class="pr-2" style="font-weight:bold;">一人暮らしの体験談を見て</br>よりよい大学生活を送るためのお部屋探しサイト</p>
  </div>
</div>
<div class="col-12 d-flex justify-content-center ">
  ...
  <div class="col py-3" style="opacity: 0.9;">
    ...
    <button type="submit" class="btn btn-danger btn-block">物件を検索</button>
  </form>
</div>
</div>
</div>
...
<div class="row  d-flex justify-content-center">
  ...
  <div class="col-sm-10 bg-light text-dark  mt-2 px-0 d-sm-block d-lg-none" style="">
    <a href="" class="justify-content-start d-flex" style="text-decoration:none;">
      ...
      <div class="text-dark">
        <h6 class="mb-0  border-bottom border-danger pb-2 mt-3">
          <strong>{{$item[$i]->name}}</strong>
        </h6>
        <div style="font-size:12px;">
          <ul style="list-style:none; " class=" py-2 pl-1">
            <li>
              {{'家賃'. number_format($item[$i]->rent).'円'}}/{{'山手線「'.$item[$i]->station.'」'}}/{{'築'.$item[$i]->age.'年'}}
              /{{'間取り'.$item[$i]->construction}}
            </li>
